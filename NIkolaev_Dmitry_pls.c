...
int main(int argc, char *argv[])
{
    ...
    while (flag)
    {
        ...
        if (isheap) printf("Not binary heap.\n");
        else printf("Binary heap.\n");
        checkprint(tree,0);
...
load file\n\
save file\n\
add root *number*- create\n\
add node *number* parent/sibling number/root\n\
rem whole - delete tree\n\
rem node *number* self/sibling/descendants/family\n\
